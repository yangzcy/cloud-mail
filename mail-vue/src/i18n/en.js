const en = {
    ...
    deleteAllEmails: 'Purge Emails',
    deleteAllEmailsConfirm: 'Confirm deleting all emails?',
    deleteAllEmailsDesc: 'This permanently deletes all email records, attachments, and stars from D1.',
    deleteAllEmailsKeepHint: 'This removes emails only and does not delete any mailbox accounts.',
    deleteAllEmailsSuccess: 'All emails have been deleted',
    ...
    deleteAllUsers: 'Purge Users',
    deleteAllUsersConfirm: 'Confirm purging all non-admin users?',
    deleteAllUsersDesc: 'This permanently deletes only regular users and removes their related D1 data, including accounts, emails, attachments, OAuth records, and stars.',
    deleteAllUsersKeepHint: 'The site admin account, super admin users, admin-role users, and their alias mailboxes, including subdomain mailboxes, will be kept.',
    deleteAllUsersSuccess: 'Permanently deleted {msg} users and their related data',
    ...
    batchManage: 'Batch delete',
    exitBatch: 'Exit batch',
    selectCurrentList: 'Select current list',
    selectAllAccounts: 'Select all accounts',
    allAccountsSelected: 'All {msg} selected',
    clearSelection: 'Clear selection',
    delUserAccountsConfirm: 'Permanently delete the selected email addresses and related mail data?',
    delUserAccountsSuccess: '{msg} email addresses permanently deleted',
    delAccountsConfirm: 'Permanently delete {msg} selected email addresses and related mail data?',
    delOneAccountConfirm: 'Permanently delete {msg} and all related mail data?',
    delAccountsSuccess: '{msg} email addresses permanently deleted',
    delOneAccountSuccess: 'Email address permanently deleted',
