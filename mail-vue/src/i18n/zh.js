const zh = {
    ...
    clearSuccess: '清除成功',
    deleteAllEmails: '一键删除邮件',
    deleteAllEmailsConfirm: '确认删除全部邮件吗？',
    deleteAllEmailsDesc: '该操作会硬删除 D1 中的全部邮件、附件与星标记录。',
    deleteAllEmailsKeepHint: '这里只删除邮件，不会删除任何邮箱账号。',
    deleteAllEmailsSuccess: '全部邮件已删除',
    emptyRole: '身份类型不能为空',
    ...
    deleteAllUsers: '一键清理用户',
    deleteAllUsersConfirm: '确认执行一键清理吗？',
    deleteAllUsersDesc: '该操作会硬删除所有普通用户，并同步清理 D1 数据中的账号、邮件、附件、OAuth 与星标记录。',
    deleteAllUsersKeepHint: '管理员账户、超级管理员用户、管理员角色用户，以及他们名下的邮箱别名（包括二级域名邮箱）都会保留。',
    deleteAllUsersSuccess: '已硬删除 {msg} 个用户及其关联数据',
    ...
    selectAllAccounts: '全选全部邮箱',
    allAccountsSelected: '已选全部 {msg} 项',
    clearSelection: '清空选择',
    delUserAccountsConfirm: '确认硬删除所选邮箱及其关联邮件数据吗？',
    delUserAccountsSuccess: '已硬删除 {msg} 个邮箱',
    delAccountsConfirm: '确认硬删除选中的 {msg} 个邮箱及其关联邮件数据吗？',
    delOneAccountConfirm: '确认硬删除 {msg} 及其关联邮件数据吗？',
    delAccountsSuccess: '已硬删除 {msg} 个邮箱',
    delOneAccountSuccess: '邮箱已硬删除',
